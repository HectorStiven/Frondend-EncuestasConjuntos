...
import { ConfiguracionCasa } from './ConfiguracionCasa/ConfiguracionCasa';
import { ConfiguracionConjunto } from './ConfiguracionConjunto/ConfiguracionConjunto';
import { ConfiguracionPersona } from './ConfiguracionPersona/ConfiguracionPersona';
